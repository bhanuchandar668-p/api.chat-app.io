...
export const direct_messages = pgTable("direct_messages", {
  ...
  read_at: timestamp(),
  reply_to: integer().references((): AnyPgColumn => direct_messages.id),
...
export type NewDirectMessage = typeof direct_messages.$inferInsert;
export type DirectMessageTable = typeof direct_messages;
