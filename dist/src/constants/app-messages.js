...
export const LOGIN_EMAIL_NOT_FOUND = "Given email not found in the system. Please check with the manager";
export const LOGIN_PHONE_NOT_FOUND = "Given phone number not found in the system. Please check with the manager";
